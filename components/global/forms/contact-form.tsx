...
export default function Example() {
  ...
  return (
    <div className="isolate bg-primary-100 px-6 py-24 sm:py-32 lg:px-8">
      <div
          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md border-0 px-3.5 py-2 text-primary-900 shadow-sm ring-1 ring-inset ring-primary-300 placeholder:text-primary-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div>
            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                ...
                <select
                  id="country"
                  name="country"
                  className="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-primary-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm"
                >
                  <option>US</option>
                  <option>CA</option>
                  <option>EU</option>
                ...
                <ChevronDownIcon
                  className="pointer-events-none absolute right-3 top-0 h-full w-5 text-primary-400"
                  aria-hidden="true"
                />
              </div>
              <input
